...
If you want to develop a new rule, follow as an example the already existing rules in the [rule package](https://github.com/remerge/revive/tree/master/rule).
...
If you want to develop a new formatter, follow as an example the already existing formatters in the [formatter package](https://github.com/remerge/revive/tree/master/formatter).
